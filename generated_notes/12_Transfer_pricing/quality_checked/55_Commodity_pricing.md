...
The **OECD Transfer Pricing Guidelines for Multinational Enterprises and Tax Administrations (2022)** explicitly recognize the unique characteristics of commodity transactions: **"The comparable uncontrolled price method would generally be the most appropriate transfer pricing method for establishing the arm's length price for commodity transfers between associated enterprises"** (Chapter II, Section C).

**Purpose of CUP for commodities**: Commodity markets are characterized by price transparency through published benchmarks (Brent, WTI, Henry Hub), making direct price comparisons the most reliable method. This reflects the economic reality that independent buyers and sellers transact at prevailing market prices with adjustments for quality and location differences.
...
**Specifications**:
- **API gravity**: 31° (medium crude) for Dubai; 34° for Oman
- **Sulfur content**: 2.0% (sour crude) for Dubai; 1.2% for Oman
...
**Purpose of adjustment**: API gravity directly affects refining economics. Lighter crude yields higher percentages of valuable light products (gasoline, diesel, jet fuel) with lower processing costs. Refineries pay premiums for lighter crude to maximize profitable product output.
...
**Purpose of adjustment**: High-sulfur crude requires additional desulfurization processing to meet product specifications (particularly for diesel and gasoline). This increases refining costs through capital investment in hydrotreaters and higher operating expenses. Sweet crude thus commands a price premium reflecting these avoided costs.
...
**Regulation**: U.S. pipeline tariffs are **FERC-regulated** (Federal Energy Regulatory Commission under the Natural Gas Act 1938 and Interstate Commerce Act); tariffs publicly available.
...
OECD Transfer Pricing Guidelines 2022 state: **"A particularly relevant comparability factor for commodity transactions is the pricing date"** (Chapter II, para. 2.18).
...
**A. Alternative Valuation Methods in Resource-Rich Countries**

Several **resource-rich countries** have enacted legislation allowing tax authorities discretion in commodity valuation:

**Examples of jurisdictions with alternative valuation provisions**:

- **Argentina**: "Sixth Method" allows use of quoted commodity prices at specified dates (introduced 2003)
- **Ghana**: Petroleum Revenue Management Act provisions for government-determined prices
- **Kenya**: Income Tax Act provisions allowing Commissioner discretion on commodity pricing
- **Zambia**: Mining taxation provisions with alternative valuation rules

**General approach**: Tax authorities may:
...
**Nigeria context**: Nigeria follows **traditional OECD transfer pricing methods** under the Petroleum Profits Tax Act (Section 15), Income Tax (Transfer Pricing) Regulations 2018, and Companies Income Tax Act (Section 22). Nigerian tax authorities apply the arm's length principle and may challenge transfer pricing under general anti-avoidance provisions but have not adopted the "Sixth Method" approach used in some Latin American countries.

**Defense strategies** (general):
1. **Contemporaneous documentation**: Robust Local File demonstrating arm's length pricing using CUP
2. **Advance Pricing Agreement (APA)**: Bilateral APA to obtain pre-approval of methodology
...
1. **CUP method justification**: Explanation that CUP is most appropriate method for commodity transactions per OECD Transfer Pricing Guidelines 2022
...
**OECD Transfer Pricing Guidelines 2022, Chapter II, para. 2.15**:
...
## 10. Practical Application Guidance

**Benchmark Selection Framework**:

1. **Match benchmark to crude origin and destination**:
   - Atlantic Basin exports (Europe, U.S., Africa) → Brent
   - U.S. domestic → WTI
   - Middle East to Asia → Dubai/Oman

2. **Use published price reporters**: Platts, Argus Media, Bloomberg (widely recognized by tax authorities)

3. **Apply quality adjustments systematically**: Document API and sulfur differentials from published sources

4. **Prefer Internal CUP when available**: Third-party sales provide most reliable comparables

**Documentation Best Practices**:

1. **Contemporaneous preparation**: Document pricing methodology before or when transactions occur
2. **Quality certificates**: Maintain laboratory analysis of crude specifications
3. **Benchmark documentation**: Retain published price assessments (Platts, Argus) for periods used
4. **Freight quotes**: Obtain independent shipping quotes (Baltic Exchange, broker quotes)
5. **Consistency**: Apply same methodology across all transactions and periods

**Common Pitfalls to Avoid**:

1. **Pricing date mismatch**: Using different pricing dates for controlled vs. comparable transactions
2. **Unjustified adjustments**: Applying term contract premiums or volume discounts without third-party evidence
3. **Outdated adjustments**: Using quality differentials from prior years when current data available
4. **Cherry-picking quotational periods**: Selecting favorable pricing periods inconsistent with historical practice
5. **Inadequate freight benchmarking**: Accepting related-party freight charges without independent verification

---

**This chapter has examined commodity pricing methodologies, benchmark selection, quality and location adjustments, pricing date determination, and tax authority challenges, equipping tax professionals to establish defensible arm's length pricing for crude oil, natural gas, and LNG transactions.**
