...
The **OECD BEPS Action 2** (Final Report published October 5, 2015) initiative and subsequent domestic anti-hybrid rules (e.g., U.S. IRC Section 267A enacted in Tax Cuts and Jobs Act 2017, EU Council Directive (EU) 2016/1164 Article 9 as amended by Directive (EU) 2017/952) aim to neutralize these mismatches by **denying deductions** or **requiring income inclusion** to align with the counterparty's tax treatment.
...
**BEPS Action 2** (Neutralising the Effects of Hybrid Mismatch Arrangements, Final Report October 5, 2015) established a framework to **neutralize hybrid mismatch arrangements** through:
...
**Linking Rule**: Addresses indirect hybrid mismatches (e.g., back-to-back arrangements, imported mismatches).

### 3.2 U.S. Anti-Hybrid Rules (IRC Section 267A)

**Section 267A** (enacted in Tax Cuts and Jobs Act 2017, effective for tax years beginning after December 31, 2017) denies deductions for **disqualified related party amounts** that result in:
...
**Council Directive (EU) 2016/1164 as amended by Council Directive (EU) 2017/952** requires EU Member States to implement rules to prevent:

**Hybrid Mismatches** (Articles 9, 9a, 9b) resulting in:
- Double deduction
...
**Implementation**: Member States required to implement by January 1, 2020 (extended provisions by January 1, 2022).
