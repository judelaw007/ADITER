...
As examined in Chapter 51 (Group Trading Company) and Chapter 55 (Commodity Pricing), trading companies are typically established in **low-tax jurisdictions** (Switzerland 12-14%, Singapore 5-17%) to centralize **trading profits**, **risk management**, and **logistics coordination**. However, tax authorities worldwide increasingly challenge trading structures, scrutinizing **transfer pricing methodologies**, **economic substance**, and **profit attribution**.

This chapter examines **transfer pricing methods for trading** (Comparable Uncontrolled Price (CUP) for commodities, profit split for integrated trading), **attribution of trading profits** (production vs. trading vs. marketing), **tax authority challenges** (Sixth Method rule, transfer pricing adjustments), **documentation requirements** specific to trading, and **case studies** of audit defenses.
...
The **CUP method** is the **most appropriate** transfer pricing method for commodity transactions. The **Organisation for Economic Co-operation and Development (OECD) Transfer Pricing Guidelines** (2022 edition, Chapter II, paragraphs 2.18-2.26) provide that quoted commodity prices generally reflect the agreement between independent buyers and sellers in the market on the price for a specific type and amount of commodity, traded under specific conditions at a certain point in time.
...
- Benchmark: Brent Crude (published by Platts, Intercontinental Exchange (ICE))
- Quality adjustments: American Petroleum Institute (API) gravity, sulfur content
- Location adjustments: Free On Board (FOB) Norway → FOB Rotterdam equivalent
...
- Location adjustments: Freight from Norway to destination (e.g., +$3/barrel Cost, Insurance and Freight (CIF) Singapore)
...
**B. Application to Natural Gas and Liquefied Natural Gas (LNG) Trading**
...
Example:
Henry Hub: $3.00/Million British Thermal Units (MMBtu)
...
**OECD Guidance** (Transfer Pricing Guidelines, Chapter II, Section D):
...
| **Refining Co.** | Processing crude into products | Refinery (high capital expenditure) | Operating risk, margin risk | 25% |
...
**Tax authority acceptance**: **Bilateral or multilateral Advance Pricing Agreements (APAs) strongly recommended** for profit split arrangements (pre-approval by all jurisdictions involved).
...
The **DEMPE framework** was introduced in the OECD BEPS (Base Erosion and Profit Shifting) Action 8-10 reports (2015) and incorporated into the OECD Transfer Pricing Guidelines to ensure that returns from intangibles are allocated to entities that perform and control the functions related to developing, enhancing, maintaining, protecting, and exploiting those intangibles.
...
DEMPE analysis:
- **Development**: Trading Co. employs 5 quantitative analysts developing algorithms ($2M annually)
...
### 4.1 "Sixth Method" Rule (Argentina, Zambia, Ghana, Kenya, Uganda)

**Background**: Several **resource-rich countries** (primarily in Latin America and Africa) introduced the **"Sixth Method"**, empowering tax authorities to **disregard** benchmark pricing and **substitute** alternative valuations for commodity transactions.

The term "Sixth Method" refers to this approach as an additional method beyond the five traditional OECD transfer pricing methods (CUP, Resale Price, Cost Plus, Transactional Net Margin Method, Profit Split). Argentina was the first country to adopt this approach under **Income Tax Law Article 15** (amended 2003), followed by other resource-rich jurisdictions.

**Nigeria Transfer Pricing Context**:

Nigeria applies transfer pricing rules under the **Income Tax (Transfer Pricing) Regulations 2018**, which give tax authorities broad discretion to determine market value for commodity transactions. While Nigeria has not formally codified a "Sixth Method" in legislation, the **Federal Inland Revenue Service (FIRS)** has demonstrated willingness to challenge CUP pricing using alternative valuation methods, particularly for crude oil exports.
...
- Applies alternative valuation: Uses Nigerian government posted price of $85/barrel
- Adjustment: $7/barrel × 1M barrels = $7M additional taxable income

Nigeria tax impact (under Petroleum Profits Tax Act):
- For Production Sharing Contracts (PSC): $7M × 50% = $3.5M additional tax
- For Joint Ventures with Nigerian National Petroleum Corporation (NNPC): $7M × 85% = $5.95M additional tax
```
...
2. **Bilateral APA**: Negotiate **advance pricing agreement** between **Switzerland competent authority** and **Nigeria FIRS** under tax treaty Mutual Agreement Procedure (MAP)
...
**Outcome**: Nigerian courts have **accepted Internal CUP** (sales to independent parties) as strong evidence of market value; alternative valuation methods disallowed if taxpayer can demonstrate robust arm's length pricing.
...
- UK corporate tax (25% for financial year 2024/25) + penalties for failure to disclose PE
...
Angola adjustment: Tax authority values crude at $85/barrel.
- Angola taxable income increased: $7/barrel × 1M = $7M
- Angola corporate tax (25%): $1.75M
...
Result: **Double taxation** on $7M ($1.75M Angola + no relief in Singapore)
```
...
1. **Producer Co. files MAP request** with **Singapore competent authority** (Inland Revenue Authority of Singapore (IRAS))
...
```
**Parties**: Producer Co. (Norway), Trading Co. (Singapore), Norwegian Tax Administration, IRAS (Singapore)
...
**Benefit**: Eliminates $5-10M annual audit risk for $2B trading operation (return on investment: 10-20x).
...
1. **Functional analysis**:
   ...
   - **Risks**: Market risk (price volatility), credit risk (counterparty default), inventory risk, compliance risk (sanctions, Anti-Money Laundering (AML))

2. **Transfer pricing methodology**:
   - **Method**: CUP (for commodity purchases/sales) or Profit Split (for integrated trading)
   - **Benchmark selection**: Brent, West Texas Intermediate (WTI), Henry Hub, Japan Korea Marker (JKM) (justification for selected benchmark)
   - **Adjustments**: Quality (API, sulfur), location (freight), pricing date (monthly average, quotational period)

3. **Comparables analysis** (if using Transactional Net Margin Method (TNMM) or profit split):
...
**Market data**:
- **Brent monthly average (May 2024)**: $85.00/barrel
- **Vitol purchase price** (actual transaction, May 2024): $81.50/barrel FOB Bonny
...
**Nigerian tax authority audit** (2024):
- Questions whether NigeriaOil is pricing sales to SwissTrade (related) at arm's length
- Requests transfer pricing analysis
- Indicates potential application of alternative valuation methods if CUP not adequately documented
...
4. Prepare defense against potential alternative valuation challenge
...
```
Base price: Brent monthly average (May 2024) = $85.00/barrel
...
NigeriaOil sold **600,000 barrels** to **Vitol (independent)** in **May 2024**:
...
| **Pricing date** | May 2024 monthly avg Brent | Same | ✓ Yes |
...
4. **Same time period** (May 2024)
5. **Minor adjustment** (+$0.50 for term premium) is well-documented and conservative

**Step 4: Alternative Valuation Method Defense**

**Potential challenge**: Nigerian tax authority may claim $82/barrel "does not reflect prevailing commercial realities" and apply alternative valuation (e.g., Nigerian government posted price of $87/barrel).

**Defense strategy**:

**Argument 1: Internal CUP is direct evidence of market value**

> "NigeriaOil sold 600,000 barrels (30% of May production) to **Vitol**, an independent international trader, at **$81.50/barrel** FOB Bonny. This transaction occurred in the **same month** (May 2024), for the **same crude** (API 32°, sulfur 0.9%), under **same contract terms** (monthly avg Brent pricing, FOB Bonny).
>
...
> "**Vitol** is the world's largest independent oil trader (2023 revenue: $300 billion). Vitol has no relationship with NigeriaOil or SwissTrade. Vitol's willingness to pay **$81.50/barrel** for NigeriaOil crude in May 2024 is **direct market evidence** that this price reflects **prevailing commercial realities**."
...
**Argument 4: Nigerian courts have accepted Internal CUP as strong evidence**

Cite Nigerian court precedent (if available) where courts upheld taxpayer's Internal CUP and rejected alternative valuation methods when robust third-party transaction evidence existed.
...
3. **Adjustment**:
   - **Term contract premium**: +$0.50/barrel
   - **Source**: Wood Mackenzie "Crude Oil Trading Premiums and Discounts" (Q1 2024 report) indicating term contracts command $0.25-1.00/barrel premium vs. spot

4. **Transfer price**:
   - SwissTrade purchase price: $81.50 (Vitol price) + $0.50 (term premium) = **$82.00/barrel**

5. **Evidence**:
   - **Vitol contract**: Copy of sales agreement and invoice (May 2024)
   ...
   - **Pricing confirmation**: Brent monthly average (May 2024): $85.00/barrel (ICE settlement prices)
   - **Term premium study**: Wood Mackenzie report (Q1 2024)

**Result**: Nigerian tax authority **accepts $82.00/barrel** transfer price; **alternative valuation not applied** due to robust Internal CUP documentation.
...
**Tax rates**:
- **Qatar**: 10% (corporate tax for most sectors; 35% for foreign extractive companies)
- **Singapore**: 17% (standard corporate income tax rate)
- **Japan**: 30.62% (effective combined corporate tax rate including corporate income tax, local inhabitant tax, and enterprise tax for large corporations)
...
- **Production**: Ongoing gas extraction (20-year field life; Year 10 of production in 2024)

**Assets**:
- **Reserves**: 50 Tcf (trillion cubic feet) proven reserves (valued at $10B+ net present value)
