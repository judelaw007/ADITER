...
3. **EU CFC Rules** (Council Directive (EU) 2016/1164 - Anti-Tax Avoidance Directive (ATAD)):
...
- **Section 250 deduction**: 50% (reducing to 37.5% for tax years beginning after December 31, 2025)
- **Taxable GILTI**: 50% of total (current through 2025)
- **U.S. tax**: 21% on 50% = **10.5% effective rate** (increasing to 13.125% in 2026)
...
**Exemptions** (Taxation (International and Other Provisions) Act 2010 (TIOPA 2010)):

- **Low profits** (TIOPA10/S371LB): CFC with accounting profits < £500,000 (and non-trading income < £50,000) or chargeable profits < £50,000
...
|------------|--------------|------------|---------------|----------------|
| **ArcticNorge AS** | Norway | Upstream E&P (North Sea) | $200M | 78% (22% corporate + 56% petroleum tax) |
...
1. **Repatriate IP to U.S.**:
   ...
   - Benefit from **FDII** (Foreign-Derived Intangible Income) deduction: 13.125% effective rate on foreign licensing income (37.5% deduction on 21% rate, increasing to 16.406% in 2026)
