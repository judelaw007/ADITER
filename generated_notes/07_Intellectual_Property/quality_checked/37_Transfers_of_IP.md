...
### 2.1 United States: US Internal Revenue Code Section 367(d)

#### Overview

**US Internal Revenue Code Section 367(d)** governs outbound transfers of **intangible property** from U.S. persons to foreign corporations. Unlike physical assets, **IP is not eligible** for tax-free treatment under US Internal Revenue Code Section 351 (general non-recognition rule for contributions to corporations).

**US Internal Revenue Code Section 367(d)(2)(A)** provides:
...
US Internal Revenue Code Section 367(d)(4) defines **intangible property** broadly:
...
```
Annual US Internal Revenue Code Section 367(d) inclusion = FMV of IP × Arm's length royalty rate
```
...
Annual US Internal Revenue Code Section 367(d) inclusion = $100M × 5% = $5 million per year
...
**US Internal Revenue Code Section 367(d)(2)(A)(ii)(II)** allows the transferor to elect **immediate gain recognition** instead of annual inclusions:
...
**T.D. 9994** (effective October 10, 2024) provides that **US Internal Revenue Code Section 367(d) annual inclusions terminate** if:
...
**Benefit**: Eliminates ongoing US Internal Revenue Code Section 367(d) tax burden, making it easier for U.S. companies to bring IP back to the U.S. to benefit from:
...
#### Capital Contribution (US Internal Revenue Code Section 351 in U.S.)

**Structure**: U.S. parent contributes IP to foreign subsidiary in exchange for stock.

**Tax Treatment**:

- **General rule**: Tax-free under US Internal Revenue Code Section 351 (for tangible assets)
- **Exception**: US Internal Revenue Code Section 367(d) overrides non-recognition for IP transfers
...
- US Internal Revenue Code Section 367(d) annual inclusions still apply (unless immediate gain election made)
...
- **Ordinary income** (if IP is self-created or depreciable under US Internal Revenue Code Section 1231)

**Advantages**:

- **Single tax event** (vs. annual US Internal Revenue Code Section 367(d) inclusions)
...
- **Exit tax** applies (US Internal Revenue Code Section 367(d) or local exit tax regime)
...
- **Avoids US Internal Revenue Code Section 367(d)**: Since IP is co-developed (not transferred), exit tax does not apply
...
**US Internal Revenue Code Section 951A** taxes U.S. shareholders on a CFC's **GILTI**, defined as:
...
- **Effective U.S. tax rate**: Approximately **10.5%-13.125%** (after foreign tax credits and US Internal Revenue Code Section 250 deduction)
...
PetroTech Inc. will contribute SPCS to PetroTech IP B.V. in exchange for 100% of the subsidiary's stock (capital contribution under US Internal Revenue Code Section 351).
...
1. Calculate the **US Internal Revenue Code Section 367(d) annual inclusions** if PetroTech does not make the immediate recognition election
...
**Step 1: US Internal Revenue Code Section 367(d) Annual Inclusions (No Election)**

Under US Internal Revenue Code Section 367(d), PetroTech must recognize annual **deemed royalty income** equal to the arm's length amount.

**Calculation**:

The arm's length royalty is **7% of IP-attributable revenue**. However, for US Internal Revenue Code Section 367(d) purposes, the **deemed royalty** is often calculated as a percentage of FMV or using the arm's length royalty rate applied to the foreign subsidiary's revenues.
...
Total PV of US Internal Revenue Code Section 367(d) tax = $10.06M + $8.56M + $3.88M = $22.50M
```

**Step 2: Immediate Gain Recognition (With Election)**

Under **US Internal Revenue Code Section 367(d)(2)(A)(ii)(II)**, PetroTech can elect to recognize the **built-in gain** immediately:
...
**Conclusion**: Electing **immediate gain recognition** saves **$16.2 million in present value** compared to annual US Internal Revenue Code Section 367(d) inclusions.
...
US Internal Revenue Code Section 250 deduction (50% of GILTI) = $5.435M
...
2. **Elect immediate gain recognition** under US Internal Revenue Code Section 367(d) to minimize U.S. exit tax ($6.3M vs. $22.5M PV)
...
- **GILTI changes**: Proposed U.S. tax reforms may increase GILTI rates or eliminate US Internal Revenue Code Section 250 deduction
...
Under **US Internal Revenue Code Section 367(d)**, GlobalDrill has been recognizing **annual deemed royalty income** of **$8 million per year** (based on arm's length royalty rate of 8% × $100M IP value).
...
1. **Eliminate US Internal Revenue Code Section 367(d) annual inclusions**
...
1. Calculate **current annual U.S. tax** under US Internal Revenue Code Section 367(d) with IP in Bermuda
...
Under US Internal Revenue Code Section 367(d), GlobalDrill must recognize **deemed royalty income** of **$8 million per year**:

```
Annual US Internal Revenue Code Section 367(d) inclusion = $8,000,000
...
**Termination of US Internal Revenue Code Section 367(d) Inclusions**:

Under **T.D. 9994**, repatriating the IP to GlobalDrill (U.S.) **terminates** future US Internal Revenue Code Section 367(d) inclusions. GlobalDrill will no longer recognize the $8 million annual deemed royalty.
...
Even with the FDII benefit, the **full inclusion of IP income** in the U.S. results in significantly higher tax than the **limited US Internal Revenue Code Section 367(d) deemed royalty**.
...
US Internal Revenue Code Section 250 deduction (50%) = $22M
Taxable GILTI = $22M
...
```
U.S. US Internal Revenue Code Section 367(d) tax = $1,680,000
...
1. **Compliance simplification**:
   - Eliminates **annual US Internal Revenue Code Section 367(d) calculations** and reporting
...
2. **Access to U.S. R&D incentives**:
   ...
   - **US Internal Revenue Code Section 174 deduction** (amortization of R&D costs over 5 years)
...
1. **File election under T.D. 9994** to terminate US Internal Revenue Code Section 367(d) inclusions
