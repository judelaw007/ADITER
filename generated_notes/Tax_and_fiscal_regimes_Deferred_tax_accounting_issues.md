...
**IAS 12 "Income Taxes"** (revised 2017, amended 2023) requires:
...
- "More likely than not" threshold (>50% probability) versus IAS 12's "probable" (typically >50-75%)
...
Under **IFRS 6**, companies may capitalize E&E costs until technical feasibility established. Tax treatment varies:
...
**IAS 37** / **ASC 410** require recognition of asset retirement obligations (ARO) at present value, with offsetting increase to asset cost. Tax deduction typically allowed only when costs incurred.
...
**Unwinding discount**: Annual accretion expense creates additional deductible temporary differences.
...
**Full cost** (permitted US GAAP, some jurisdictions): All exploration costs capitalized
- Creates larger temporary differences as tax deduction immediate but book capitalized
- Impairment charges may create permanent differences

### 2.4 Tax Depreciation vs. Book Depreciation

Energy assets commonly receive **accelerated tax depreciation** or enhanced capital allowances:
...
Result: **Significant DTL** in early years, reversing as asset ages.
...
- Goodwill (IAS 12.15, ASC 740-10-25-13)
- Initial recognition of assets/liabilities in non-business combination not affecting accounting or taxable profit
...
When realization uncertain, **valuation allowance** (ASC 740) or reduced recognition (IAS 12) required:

**Negative evidence**:
- Cumulative losses in recent years
- History of tax losses expiring unused
- Uncertain future profitability (e.g., unproven reserves)

**Positive evidence**:
- Existing contracts (e.g., long-term offtake agreements)
- Proven reserves supporting future production
- Strong forward commodity prices
- Reversing DTLs of same tax jurisdiction

**Example**: Company with USD 100M tax loss carryforward (DTA USD 30M at 30%) and three consecutive loss years → Valuation allowance USD 30M likely required unless substantial proven reserves demonstrate future profitability.
...
**Multi-rate regimes**: Common in energy taxation
- Norwegian petroleum: 22% general + 56% special tax = 78% combined
- UK North Sea: 30% ring fence corporation tax + 10% supplementary = 40% (reduced from 62% in 2022)

**Rate changes**: Remeasure all deferred tax balances, recognizing impact in current period tax expense (unless related to OCI items).
...
- Same tax jurisdiction and entity

Energy companies often have:
- Current DTL: Accelerated depreciation
- Non-current DTA: Decommissioning provisions
- Separate presentation by jurisdiction required
...
Disclose movements in deferred tax balances:
- Opening balance
...
- E&E capitalized: USD 200M (successful), amortizing over 10 years (book), immediately deductible (tax)

**Liabilities**:
- Decommissioning provision: USD 60M (PV), actual cost in Year 20, tax deductible when paid

**Tax rate**: 40% (UK ring fence + supplementary)
...
**Valuation allowance assessment**: If PetroNorth has proven reserves supporting 15-year profitable production, full recognition appropriate. If reserves unproven or commodity prices weak, valuation allowance on loss carryforward DTA may be required.
...
**Income statement**: Tax benefit of USD 36.8M reduces effective rate to -24.5% on profit of USD 150M.

## 6. Recent Developments (2023-2025)

**IAS 12 Amendments (effective 2023)**: "Deferred Tax related to Assets and Liabilities arising from a Single Transaction" requires recognition of deferred tax on transactions creating equal taxable and deductible temporary differences (e.g., leases, decommissioning). Eliminates previous exemption, increasing DTA and DTL recognition.

**Pillar Two Implementation (2024-2025)**: IAS 12 amendments exempt Pillar Two income taxes from deferred tax accounting. Instead, companies account for Pillar Two tax as current tax when incurred and provide specific disclosures about exposure.

**IFRS 18 "Presentation and Disclosure" (effective 2027)**: Enhanced tax disclosures including disaggregation of current and deferred tax by jurisdiction and nature.

**ASC 740 Updates (2024)**: SEC requires enhanced disclosure of rate reconciliation items exceeding 5% in annual filings, affecting energy companies with complex multi-jurisdictional operations.

**Climate-related tax incentives**: Increased deferred tax complexity from investment tax credits (ITCs) for carbon capture (US Section 45Q), hydrogen production (Section 45V), requiring assessment of realizability based on project economics.

---

**Word Count**: 1,000 words
**Examples**: 1 comprehensive worked example
