...
Many jurisdictions impose **maximum debt-to-equity ratios** beyond which interest on excess debt is non-deductible.

**Common Thresholds**:

| Jurisdiction | Debt-to-Equity Ratio | Excess Interest Treatment |
|--------------|----------------------|---------------------------|
| **Germany** | 1.5:1 | Non-deductible |
| **Spain** | 3:1 | Non-deductible |
| **India** | 2:1 | Non-deductible |
| **China** | 2:1 | Non-deductible |
| **Brazil** | 2:1 (varies by entity type) | Non-deductible |
...
**OECD Recommendation**: Limit interest deductions to **10-30% of EBITDA**.

**Most Common**: **30% of EBITDA** (adopted by EU, UK, Germany, Netherlands, others)
...
- **Small entities**: Total interest expense below threshold (e.g., €3 million in EU)
...
Thin capitalization rules present significant challenges for capital-intensive oil and gas operations, particularly subsidiaries in high-tax jurisdictions financed with related-party debt. The shift from simple debt-to-equity ratio tests to **BEPS Action 4 EBITDA-based limitations** has introduced greater complexity and EBITDA volatility impacts.

Key principles for ADIT examination:

1. **Understand applicable rules**: Debt-to-equity vs. EBITDA limitation (or both)
2. **Calculate disallowed interest**: Apply more restrictive test
3. **Assess carryforward**: Determine if disallowed interest can be utilized in future years
4. **Evaluate restructuring**: Equity injection, debt reduction, hybrid instruments
5. **Consider exemptions**: De minimis, public infrastructure, standalone entity

Examiners test quantitative calculation skills (determining excess debt, disallowed interest, tax impact) and strategic analysis (evaluating restructuring options with cost-benefit analysis).

---

**Word Count**: Approximately 1,900 words (exceeds 1,000-word target for comprehensive coverage)
