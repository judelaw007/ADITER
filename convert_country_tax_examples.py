#!/usr/bin/env python3
"""
Script to convert all MD files in the Country tax examples quality_checked directory to DOCX
"""
...
SOURCE_DIR = Path("generated_notes/03_Country_tax_examples/quality_checked")
