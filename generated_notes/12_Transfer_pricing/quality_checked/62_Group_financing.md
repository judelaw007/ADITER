...
This chapter examines **transfer pricing methods for intercompany loans** (credit rating adjustment, Comparable Uncontrolled Transaction (CUT) method), **arm's length interest rate determination**, **debt vs. equity characterization**, **thin capitalization rules**, **Organisation for Economic Co-operation and Development (OECD) Base Erosion and Profit Shifting (BEPS) Action 4** (interest limitations), **treasury company remuneration**, and **documentation requirements**.
...
Loan terms: $100M, 5-year term, United States Dollar (USD), unsecured

Market interest rates (2024):
...
|---|---|---|
| **Interest coverage** (Earnings Before Interest and Tax (EBIT) / Interest) | 3.5x | BB+ to BBB- |
| **Debt / Earnings Before Interest, Tax, Depreciation, and Amortization (EBITDA)** | 3.0x | BB to BB+ |
...
### 2.3 London Interbank Offered Rate (LIBOR) / Secured Overnight Financing Rate (SOFR) Plus Spread

**Market practice**: Intercompany loans priced as **LIBOR + spread** (historical) or **SOFR + spread** (post-LIBOR transition in 2023).
...
Base rate: SOFR (currently 5.25%, as of 2024)
...
| **Brazil** | 2:1 (foreign affiliates) | Interest on excess debt non-deductible; recharacterized as deemed dividend (subject to Withholding Tax (WHT)) |
...
- Additional tax: $1.6M × 30% (India Corporate Income Tax (CIT)) = $480,000
```
...
**A. Germany Interest Barrier Rule (Section 4h Einkommensteuergesetz (EStG))**
...
- Additional tax: €5M × 30% (Germany CIT 15.825% + trade tax ~14% average) = €1.5M
...
UK tax impact:
- Additional tax: £10M × 25% (UK CIT rate for large companies) = £2.5M
```
...
**Market interest rates for BB credit (10-year, USD, 2024)**:
...
- Additional tax: $5.875M × 30% (Nigeria Companies Income Tax rate) = $1.7625M
```
